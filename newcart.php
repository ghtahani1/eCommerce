...
foreach ($items as $item => $qty){
    // echo "Item ID: " . $items . " Quantity: " . $qty . "<br />\\r";

    echo "Item ID: " . $item . " Quantity: " . $qty . "<br />\\r";
    ...
    <div class="center">
       <div class="input-group">
          ...
          <input type="text"  name="qty" value = "<?php echo $qty ?> "  class="form-group input-number" min="1" max="5" style="
          width: 100%">
